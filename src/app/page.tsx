  ...
  return (
    <>
      ...
      <div className="flex flex-col min-h-screen font-[family-name:var(--font-geist-sans)]">
        <Header />
        <main className="flex-1 flex flex-col items-start space-y-4 p-20 pt-0 pb-20 md:gap-4 sm:p-8 sm:pt-0">
          ...
          <div className="animate-in fade-in slide-in-from-top-4 duration-500 delay-300">
            <p>
              ...
              code, but I&apos;m not afraid to get my hands dirty with the API either. Historically, I&apos;ve worked
              with DustJS, Mustache, Handlebars, ReactJS, and AngularJS. While I am most at home in TypeScript, I have
              also proven my chops with C++, C#, Java, and Python.
            </p>
            <p>
            ...
            <p>
              ...
              <strong>Wowhead</strong>, <strong>Ask.com</strong>, and various other small-to-medium organizations. While
              I have a lot of experience with greenfield development, brownfield and legacy projects have also
